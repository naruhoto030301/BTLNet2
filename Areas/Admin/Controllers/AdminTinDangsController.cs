...
namespace BTLNet2_Nhom11.Areas.Admin.Controllers
{
    ...
    public class AdminTinDangsController : Controller
    {
        ...
        public AdminTinDangsController(ApplicationDbContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.TinDangs'  is null.");
            }
            var tinDang = await _context.TinDangs.FindAsync(id);
            if (tinDang != null)
            {
